...
{
    // Taken from: https://raw.githubusercontent.com/EvaisaDev/LethalThings/main/LethalThings/MonoBehaviours/CustomNetworkTransform.cs
    public class CustomNetworkTransform : NetworkBehaviour
    {
        ...
        {
            if (IsServer && NetworkUtil.ServerHasMod)
            {
                if (syncPosition)
                {
